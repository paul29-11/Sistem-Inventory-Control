...
<section class="content-header">
  <h1>
    <i class="fa fa-arrow-circle-left icon-title"></i> Data Barang Masuk
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Kode Barang Masuk</th>
                <th class="center">Tanggal</th>
                <th class="center">Kode Barang</th>
                <th class="center">Nama Nama Barang</th>
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_masuk,a.kode_barang,a.jumlah_masuk,b.kode_barang,b.nama_barang,b.satuan
                                            FROM barang_masuk as a INNER JOIN barang as b ON a.kode_barang=b.kode_barang ORDER BY kode_transaksi DESC")
