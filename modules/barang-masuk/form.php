        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/barang-masuk/proses.php?act=insert" method="POST" name="formBarangMasuk">
            <div class="box-body">
              ...
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(kode_transaksi,7) as kode FROM barang_masuk
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="kode_barang" data-placeholder="-- Pilih Barang --" onchange="tampil_barang(this)" autocomplete="off" required>
                    <option value=""></option>
                    <?php
                    $query_barang = mysqli_query($mysqli, "SELECT kode_barang, nama_barang FROM barang ORDER BY nama_barang ASC")
                      or die('Ada kesalahan pada query tampil barang: ' . mysqli_error($mysqli));
                    while ($data_barang = mysqli_fetch_assoc($query_barang)) {
                      echo "<option value=\"$data_barang[nama_barang]\">$data_barang[nama_barang] </option>";
                    }
                    ?>
                  </select>
                </div>
