...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO barang(kode_barang,nama_barang,harga_beli,harga_jual,satuan,created_user,updated_user)
    ...
    elseif ($_GET['act']=='update') {
        if (isset($_POST['simpan'])) {
            if (isset($_POST['kode_barang'])) {
                ...
                $query = mysqli_query($mysqli, "UPDATE barang SET  nama_barang       = '$nama_barang',
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            $query = mysqli_query($mysqli, "DELETE FROM barang WHERE kode_barang='$kode_barang'")
