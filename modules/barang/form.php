        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/barang/proses.php?act=insert" method="POST">
            <div class="box-body">
              ...
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(kode_barang,6) as kode FROM barang
...
elseif ($_GET['form']=='edit') {
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT kode_barang,nama_barang,harga_beli,harga_jual,satuan FROM barang WHERE kode_barang='$_GET[id]'")
