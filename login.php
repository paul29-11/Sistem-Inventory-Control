...
<html>
  <head>
    ...
    <meta name="description" content="Aplikasi Inventory Control">
    <meta name="author" content="Rizwan Hidayat" />
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="login-check.php" method="POST">
          ...
          <div class="row">
            <div class="col-xs-12">
              <input type="submit" class="btn btn-info btn-lg btn-block btn-flat" name="login" value="Login" style="border-radius: 40px;"/>
            </div><!-- /.col -->
          </div>
        </form>
